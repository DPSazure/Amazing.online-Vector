  ...
  const pages = {
    home: `
      ...
      <div class="grid-units">
        <div class="unit-card"><h3>⚔ 1-й Штурмовой отряд</h3><p>Основная ударная сила ЧВК. Проведение наступательных операций, зачистка зданий, подавление огневых точек. Личный состав оснащён тяжёлым вооружением и бронетехникой.</p></div>
        <div class="unit-card"><h3>🏥 2 Группа тактико-медицинской обороны</h3><p>Эвакуация раненых с поля боя, неотложная медицинская помощь, тактическая поддержка подразделений.</p></div>
        <div class="unit-card"><h3>🎯 Отряд сил специальных операций «Барс»</h3><p>Глубинная разведка, диверсионные рейды, точечные ликвидации, освобождение заложников.</p></div>
        <div class="unit-card"><h3>🌊 1-й Взвод морской пехоты</h3><p>Амфибийные операции, десантирование с воды, охрана портов и прибрежной инфраструктуры.</p></div>
        <div class="unit-card"><h3>🛡 Оперативное реагирование по делам береговой охраны</h3><p>Патрулирование прибрежной зоны, предотвращение контрабанды, быстрое реагирование на морские угрозы.</p></div>
      </div>
      <div class="section-title">Командование и управление</div>
      <div class="grid-units">
        <div class="unit-card"><h3>🏛 Генеральный штаб НВО <span class="badge">Генсовет</span></h3><p>Высший орган управления ЧВК. Разработка стратегических планов, координация всех подразделений. Состоит из трёх членов Генерального совета.</p></div>
        <div class="unit-card"><h3>🔍 Разведывательное управление НВО</h3><p>Сбор и анализ разведывательной информации, агентурная сеть, радиоперехват, картографирование.</p></div>
        <div class="unit-card"><h3>⚖ Следственный комитет по делам военнослужащих</h3><p>Внутренняя безопасность: расследование преступлений и нарушений среди личного состава, поддержание дисциплины.</p></div>
        <div class="unit-card"><h3>📋 ОБР (отдел быстрого реагирования)</h3><p>Мобильная группа для экстренного усиления, оперативного прикрытия объектов, реагирования на сигналы тревоги.</p></div>
      </div>
    `,
    structure: `
      ...
      <div class="grid-units">
        ...
        <div class="unit-card"><h3>🏥 2 Группа тактико-медицинской обороны</h3><p>Оказание неотложной помощи в полевых условиях, эвакуация раненых, медицинское обеспечение боевых выходов.</p></div>
        <div class="unit-card"><h3>🎯 ОСпН «Барс»</h3><p>Силы специальных операций: глубинная разведка, диверсии, снайперская поддержка, освобождение заложников.</p></div>
        <div class="unit-card"><h3>🌊 1-й Взвод морской пехоты</h3><p>Амфибийные подразделения, способные высаживаться с воды. Охрана портовой инфраструктуры, десантные операции.</p></div>
        <div class="unit-card"><h3>🛡 Оперативное реагирование по делам береговой охраны</h3><p>Контроль прибрежной зоны: выявление контрабандистов, предотвращение несанкционированного проникновения.</p></div>
        <div class="unit-card"><h3>🏛 Генеральный штаб НВО <span class="badge">Генсовет</span></h3><p>Стратегическое командование, состоящее из трёх членов Генерального совета.</p></div>
        <div class="unit-card"><h3>🔍 Разведывательное управление НВО</h3><p>Агентурная и техническая разведка, сбор информации о противнике, картографирование, радиоперехват.</p></div>
        <div class="unit-card"><h3>⚖ Следственный комитет по делам военнослужащих</h3><p>Внутренняя безопасность: расследование преступлений и нарушений среди личного состава.</p></div>
        <div class="unit-card"><h3>📋 ОБР (отдел быстрого реагирования)</h3><p>Мобильная группа для экстренного решения вопросов частной оборонительной системы.</p></div>
      </div>
    `,
    orders: ordersHTML,
    contact: `
